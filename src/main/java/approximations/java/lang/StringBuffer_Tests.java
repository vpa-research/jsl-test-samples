...
public final class StringBuffer_Tests {
    ...
    public static int test_append_4(final int execution) {
        ...
        StringBuffer sequence_3 = new StringBuffer("סכמגמ");
        stringBuffer.append(sequence_3);
        if (execution == 2) {
            if (stringBuffer.length() == 19 && stringBuffer.charAt(17) == sequence_3.charAt(3))
                return 2;
    ...
    public static int test_append_6(final int execution) {
        ...
        if (execution == 1) {
            if (stringBuffer.length() == 2 && stringBuffer.charAt(1) == 'ה')
                return 1;
            else
                return -1;
        }
    ...
    public static int test_append_7(final int execution) {
        ...
        stringBuffer.append(ch3);
        if (execution == 2) {
            if (stringBuffer.length() == 7 && stringBuffer.charAt(6) == 'ג')
                return 2;
            else
                return -1;
        }
    ...
    public static int test_appendCodePoint_0(final int execution) {
        ...
        if (execution == 2) {
            if (stringBuffer.length() == 2 && stringBuffer.charAt(1) == 'ג')
                return 2;
            else
                return -1;
        }
    ...
    public static int test_insert_0(final int execution) {
        ...
        if (execution == 3) {
            if (stringBuffer.length() == 19 && stringBuffer.charAt(10) == 'ס')
                return 3;
            else
                return -1;
        }
    ...
    public static int test_insert_1(final int execution) {
        ...
        if (execution == 3) {
            if (stringBuffer.length() == 6 && stringBuffer.charAt(5) == 'מ')
                return 3;
            else
                return -1;
        }
    ...
    public static int test_insert_9(final int execution) {
        ...
        if (execution == 3) {
            if (stringBuffer.length() == 20 && stringBuffer.charAt(8) == '3')
                return 3;
            else
                return -1;
        }
        ...
        stringBuffer.insert(0, 12E-1);
        if (execution == 4) {
            if (stringBuffer.length() == 23 && stringBuffer.charAt(1) == '.' && stringBuffer.charAt(2) == '2')
                return 4;
            else
                return -1;
        }
    ...
    public static int test_setCharAt_0(final int execution) {
        ...
        stringBuffer.setCharAt(9, 'ג');
        if (execution == 2) {
            if (stringBuffer.charAt(9) == 'ג' && stringBuffer.length() == 10)
                return 2;
            else
                return -1;
        }
